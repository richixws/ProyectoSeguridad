...
public interface IPerfilService {
    ...
    public PerfilResponse getAllPerfiles(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder, Integer idSistema, Integer idPerfil);//, String nombre
